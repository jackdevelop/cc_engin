...
export default class node_avatar extends BaseComponent {
  ...
  @property({ type: cc.Label, tooltip: "金币" }) txt_gold: cc.Label = null;
  @property({ type: cc.Label, tooltip: "用户名称" })
  txt_nickname: cc.Label = null;
  @property({ type: cc.Label, tooltip: "用户所在城市" })
  txt_city: cc.Label = null;
  @property({ type: cc.Label, tooltip: "用户IP" }) txt_ip: cc.Label = null;
  @property({ type: cc.Sprite, tooltip: "头像" }) spt_avatar: cc.Sprite = null;
  @property({ type: cc.Sprite, tooltip: "vip" }) spt_vip: cc.Sprite = null;
