...
export default class Notice extends cc.Component {
  ...
  @property({ type: cc.Sprite, tooltip: "图片" }) spt_notice: cc.Sprite = null;
  @property({ type: cc.Float, tooltip: "多久刷新一次" }) time: cc.Float = 0.01;
  @property({ type: cc.Integer, tooltip: "每次x变化多少" })
  time_add_x: cc.Integer = 1;
  @property({ type: cc.Boolean, tooltip: "当公告显示完，是否自动隐藏起来 " })
  auto_hide: cc.Boolean = true;
  private _data = [];
