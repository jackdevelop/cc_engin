...
export class ShaderProperty {
  @property({ readonly: true }) key = "";
  @property(cc.Float) value = 0.0;
}
const ShaderEnum = cc.Enum({ a: 1 });
@ccclass
@executeInEditMode
export default class ShaderHelper extends cc.Component {
  @property _program = 0;
  @property({ type: ShaderEnum }) get program() {
  ...
  @property({ type: [ShaderProperty] }) _props: ShaderProperty[] = [];
  @property({ type: [ShaderProperty] }) get props(): ShaderProperty[] {
    return this._props;
  }
  set props(value) {
    this._props = value;
