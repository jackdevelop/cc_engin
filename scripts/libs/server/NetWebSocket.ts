...
export class NetWebSocket extends BaseNet {
	...
	public prepareWebSocket(ip, port, netName, param, fun) {
        ...
        // cc.log(param)
        serverUrl = StringExtension.appendGetPathParams2(serverUrl, param,"&");
        ...
        //serverUrl = "ws://121.43.177.159:8080/messagews?Authorization=eyJhbGciOiJIUzUxMiJ9.eyJ1c2VyX2lkIjoxMDUsImN1cnJlbnRfdGltZSI6MTY1Mjc2MDYzNjY3NX0.11Fx4Bj8GNUoqgfK5bMCASNVLLIQxJrSR-zDBOAVGZHwcSNMxFKhtWosFgvdmDwpsYoMslhpjtultwPT-B0pRA"
	...
	public close(dispatchEvent = true) {
		...
		cc.log('NetWebSocket.js 手动断开连接', this._netName, dispatchEvent);
		if (!this._webSocket) {
			return;
		}
