...
export class GameEventConstants {
  ...
  public static PANEL_OPEN_START = 'PANEL_OPEN_START'; 
  public static PANEL_OPEN_BEGIN = 'PANEL_OPEN_BEGIN';
  public static PANEL_OPEN = 'PANEL_OPEN'; 
  ...
  public static server_pay_state_change = 'server_pay_state_change'; 
  ...
  public static server_hall_join_match = 'server_hall_join_match';
  public static server_hall_quit_match = 'server_hall_quit_match';
  ...
  public static room_enter = 'room_enter';
  public static server_room_ready = 'server_room_ready';


  public static server_room_status_changed_before = 'server_room_status_changed_before';
  public static server_room_status_changed = 'server_room_status_changed';

  public static server_room_game_action_before = 'server_room_game_action_before';
